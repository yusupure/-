...
class LagouSpider(CrawlSpider):
    ...
    def parse_item(self,response):
        ...
        acritel.add_xpath('job_salary',"/html/body/div[2]/div/div[1]/dd/p[1]/span[1]/text()")
        acritel.add_xpath('job_address', "/html/body/div[2]/div/div[1]/dd/p[1]/span[2]/text()")
        acritel.add_xpath('job_experience', "/html/body/div[2]/div/div[1]/dd/p[1]/span[3]/text()")
        acritel.add_xpath('job_education', "/html/body/div[2]/div/div[1]/dd/p[1]/span[4]/text()")
        acritel.add_xpath('job_request', "/html/body/div[2]/div/div[1]/dd/p[1]/span[5]/text()")
